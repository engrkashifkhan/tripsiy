...
const ActivityDetail = () => {
  ...
  console.log("Detail Page - URL ID:", id);
  
  // Find activity directly from activities array using URL parameter
  const activity = activities.find(item => item.id === parseInt(id));
  
  console.log("Detail Page - Found Activity:", activity);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 bg-white rounded-2xl shadow-xl p-6">
              ...
              <button className="w-full mt-8 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-4 rounded-xl transition-colors duration-200 text-lg">
                Book Now
              </button>

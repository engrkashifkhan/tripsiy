...
//     rating: 4.8,
//     image: "/dubai_2.jpg",
//     gallery: ["/dubai_1.jpg", "/dubai_2.jpg", "/dubai_3.jpg"],
//     itinerary: [
//       {
//         day: "Day 1",
//         desc: "Arrival in Dubai, city highlights"
//       },
//       {
//         day: "Day 2",
//         desc: "Desert safari, camel rides, BBQ dinner."
//       },
//       {
//         day: "Day 3-4",
//         desc: "Atlantis, aquarium, Dhow cruise, Dubai Fountain"
//       },
//       {
//         day: "Day 5",
//         desc: "Palm Jumeirah, Jumeirah Beach"
//       },
//       {
//         day: "Day 6-7",
//         desc: "Dubai Frame, Al Fahidi, shopping, Global Village."
//       },
//       {
//         day: "Day 8",
//         desc: "Leisure morning, departure."
//       }
//     ],
//     inclusions: ["Hotel", "Breakfast", "Airport", "Tours"],
//     exclusions: ["Fighting", "Personal Expenses", "Tips"]
//   },
//   {
//     id: 2,
//     country: "Bali",
...
//     rating: 4.7,
//     image: "/bali_2.jpg",
//     gallery: ["/bali_1.jpg", "/bali_2.jpg", "/bali_3.jpg"],
//     itinerary: [
//       {
//         day: "Day 1",
//         desc: "Arrival in Bali, transfer to hotel"
//       },
//       {
//         day: "Day 2",
//         desc: "Ubud tour and traditional dance"
//       },
//       {
//         day: "Day 3",
//         desc: "Beach activities and water sports"
//       },
//       {
//         day: "Day 4",
//         desc: "Temple visits and cultural experience"
//       },
//       {
//         day: "Day 5",
//         desc: "Free day for shopping and relaxation"
//       },
//       {
//         day: "Day 6",
//         desc: "Departure"
...
//     ],
//     inclusions: ["Hotel", "Breakfast", "Airport", "Tours"],
//     exclusions: ["Personal Expenses", "Tips", "Fighting"]
//   },
//   {
//     id: 3,
//     country: "Cappadocia",
...
//     gallery: ["/cappadocia_1.jpg", "/cappadocia_2.jpg", "/cappadocia_3.jpg"],
//     itinerary: [
//       {
//         day: "Day 1",
//         desc: "Arrival and cave hotel check-in"
//       },
//       {
//         day: "Day 2",
//         desc: "Hot air balloon ride at sunrise"
//       },
//       {
//         day: "Day 3",
//         desc: "Underground city tour and valley hiking"
//       },
//       {
//         day: "Day 4",
//         desc: "Traditional pottery workshop and departure"
//       }
//     ],
//     inclusions: ["Hotel", "Breakfast", "Airport", "Tours"],
...
//   // Find package - first try filteredPackages, then fall back to packagesData
//   const packageItem = filteredPackages.find(item => item.id === parseInt(id)) ||
...
const homepagePackagesData = [
  {
    id: 101, // Match the IDs from HomepagePackages
    country: "Dubai",
    name: "Dubai City Tour",
    desc: "Experience the luxury and modern marvels of Dubai",
    days: "3 Days / 2 Nights",
    ...
    itinerary: [
      {
        day: "Day 1",
        desc: "Arrival in Dubai, Burj Khalifa visit"
      },
      {
        day: "Day 2",
        desc: "Desert safari and traditional experiences"
      },
      {
        day: "Day 3",
        desc: "Dubai Mall and departure"
      }
    ],
    inclusions: ["Hotel", "Breakfast", "Airport Transfer", "City Tour"],
    exclusions: ["Personal Expenses", "Tips", "Optional Activities"]
  },
  {
    id: 102,
    ...
    itinerary: [
      {
        day: "Day 1",
        desc: "Arrival and beach resort check-in"
      },
      {
        day: "Day 2",
        desc: "Ubud cultural tour and rice terraces"
      },
      {
        day: "Day 3",
        desc: "Water sports and beach activities"
      },
      {
        day: "Day 4",
        desc: "Temple visits and spa treatment"
      },
      {
        day: "Day 5",
        desc: "Departure with lasting memories"
      }
    ],
    inclusions: ["Luxury Hotel", "All Meals", "Airport Transfer", "Tours", "Spa"],
  ...
  },
  {
    ...
    inclusions: ["Cave Hotel", "Breakfast", "Hot Air Balloon Ride", "Tours"],
    exclusions: ["Personal Expenses", "Tips", "Optional Activities"]
  },
  {
    id: 104,
    ...
    rating: 4.6,
    image: "/greece_1.jpg",
    gallery: ["/greece_1.jpg", "/greece_2.jpg", "/greece_3.jpg"],
    itinerary: [
      {
        day: "Day 1",
        desc: "Arrival in Athens and city tour"
      },
      {
        day: "Day 2",
        desc: "Santorini island transfer and sunset views"
      },
      {
        day: "Day 3",
        desc: "Beach day and wine tasting"
      },
      {
        day: "Day 4",
        desc: "Ancient ruins and cultural sites"
      },
      {
        day: "Day 5",
        desc: "Last minute shopping and departure"
      }
    ],
    inclusions: ["Hotel", "Breakfast", "Island Transfer", "Wine Tasting"],
    exclusions: ["Personal Expenses", "Tips", "Additional Meals"]
  }
];
...
export default function PackageDetails() {
  ...
  console.log('Looking in filteredPackages:', filteredPackages);
  console.log('Looking in packagesData:', packagesData);
  console.log('Looking in homepagePackagesData:', homepagePackagesData);

  // Find package - check all data sources in order of priority
  const packageItem = 
  ...
  // ... rest of your existing code (useState, form handling, etc.) remains exactly the same
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mt-2">Package ID: {id}</p>
          <button
            onClick={() => navigate("/")}
            className="mt-4 py-2 bg-[rgba(244,156,11,1)] text-white rounded-lg"
          >
